...
i = 0
lines = []
lines("atlantgis:sherdtype_G rdf:type atlantgis:SherdType .")
lines("atlantgis:sherdtype_G rdfs:label \"Gefäß\"@de .")
lines("atlantgis:sherdtype_G rdfs:label \"Vessel\"@en .")
lines("atlantgis:sherdtype_R rdf:type atlantgis:SherdType .")
lines("atlantgis:sherdtype_R rdfs:label \"Rand\"@de .")
lines("atlantgis:sherdtype_R rdfs:label \"Edge\"@en .")
lines("atlantgis:sherdtype_W rdf:type atlantgis:SherdType .")
lines("atlantgis:sherdtype_W rdfs:label \"Wall\"@en .")
lines("atlantgis:sherdtype_W rdfs:label \"Wand\"@de .")
lines("atlantgis:sherdtype_B rdf:type atlantgis:SherdType .")
lines("atlantgis:sherdtype_B rdfs:label \"Boden\"@de .")
lines("atlantgis:sherdtype_B rdfs:label \"Floor\"@en .")
for index, row in data.iterrows():
    ...
    lines.append("find:find"+str(i)+"_weight"+" " + "om:hasNumericalValue" + " " "'" + str(row['wt']) + "'^^xsd:double"+" .")
    ...
    if row['wall'] != -1:
        ...
        lines.append("find:find"+str(i)+"_wall " + "om:hasNumericalValue " + "'" + str(row['wall']) + "'^^xsd:double .")
    if row['muendungsD'] != -1.0:
        ...
        lines.append("find:find"+str(i)+"_muendungsD " + "om:hasNumericalValue " + "'" + str(row['muendungsD']) + "'^^xsd:double .")
    if row['muendungsH'] != -1.0:
        ...
        lines.append("find:find"+str(i)+"_muendungsH " + "om:hasNumericalValue " + "'" + str(row['muendungsH']) + "'^^xsd:double .")
    if row['minD'] != -1.0:
        ...
        lines.append("find:find"+str(i)+"_minD " + "om:hasNumericalValue " + "'" + str(row['minD']) + "'^^xsd:double .")
    if row['minD_H'] != -1.0:
        ...
        lines.append("find:find" + str(i) + "_minD_H " + "om:hasNumericalValue" + " " + "'" + str(row['minD_H']) + "'^^xsd:double .")
    ...
    if row['maxD'] != -1.0:
        ...
        lines.append("find:find"+str(i)+"_maxD " + "om:hasNumericalValue " + "'" + str(row['maxD']) + "'^^xsd:double .")
    if row['maxD_H'] != -1.0:
        ...
        lines.append("find:find" + str(i) + "_maxD_H " + "om:hasNumericalValue" + " " + "'" + str(row['maxD_H']) + "'^^xsd:double .")
    ...
    if row['bodenD'] != -1.0:
        ...
        lines.append("find:find" + str(i) + "_bodenD " + "om:hasNumericalValue" + " " + "'" + str(row['bodenD']) + "'^^xsd:double .")
