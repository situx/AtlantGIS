...
for rd in roads:
    ...
    g.add((URIRef(datans+"fortress"+str(featcounter)),URIRef("http://www.w3.org/2006/time#hasTime"),URIRef(datans+"period/period"+str(rd["period"]))))
    g.add((URIRef(datans+"periods/period"+str(rd["period"])),URIRef("http://www.w3.org/2006/time#after"),URIRef(datans+"period/period17")))
    ...
    g.add((URIRef(datans+"periods/period"+str(rd["period"])),URIRef("http://www.w3.org/2006/time#before"),URIRef(datans+"period/period25")))
